...
describe('featureFlagPlugin', () => {
  ...
  it('should transform code and remove feature flag comments', () => {
    ...
    const result = (plugin.transform as any)(testCode, 'test.js')
  ...
  it('should not transform files that are excluded', () => {
    ...
    const result = (plugin.transform as any)(testCode, 'excluded.js')
  ...
  it('should handle custom rule markers', () => {
    ...
    const result = (plugin.transform as any)(testCode, 'test.html')
  ...
  it('should handle file type filtering', () => {
    ...
    const result = (plugin.transform as any)(testCode, 'test.ts')
